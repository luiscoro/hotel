...
if (strlen($_SESSION['hbmsaid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		if (!in_array($extension, $allowed_extensions)) {
			...
			if ($LastInsertId > 0) {
				echo '<script>alert("El servicio ha sido registrado");</script>';
				echo "<script>window.location.href ='add-facility.php'</script>";
			} else {
				echo '<script>alert("El servicio no ha sido registrado");</script>';
			}
		}
	}
?>
	...
	<head>
		...
		<title>Rio Hotel | Agregar Servicio</title>
		<!-- Favicon -->
