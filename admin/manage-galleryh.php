...
if (strlen($_SESSION['hbmsaid'] == 0)) {
    ...
    if (isset($_GET['delid'])) {
        ...
        $sql1 = "SELECT * from tblgalleryh where ID=$rid";
        ...
        $sql = "delete from tblgalleryh where ID=:rid";
        $query = $dbh->prepare($sql);
        $query->bindParam(':rid', $rid, PDO::PARAM_STR);
        $query->execute();
        echo "<script>alert('La imagen ha sido eliminada');</script>";
        echo "<script>window.location.href = 'manage-galleryh.php'</script>";
    }
?>
    <!DOCTYPE HTML>
    <html>
                                    ...
                                    <div class="forms">
                                        <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                            <div class="form-title">
                                                <h4>Gestionar galería de hotel</h4>
                                            </div>
                                            <div class="form-body">
                                                ...
                                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $ret = "SELECT ID FROM tblgalleryh";
                                                        $query1 = $dbh->prepare($ret);
                                                        $query1->execute();
                                                        $results1 = $query1->fetchAll(PDO::FETCH_OBJ);
                                                        $total_rows = $query1->rowCount();
                                                        $total_pages = ceil($total_rows / $no_of_records_per_page);
                                                        $sql = "SELECT * from tblgalleryh LIMIT $offset, $no_of_records_per_page";
                                                        $query = $dbh->prepare($sql);
                                                        $query->execute();
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $row) {               ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="d-none d-sm-table-cell"><a href="manage-galleryh.php?delid=<?php echo ($row->ID); ?>">Eliminar</a></td>
