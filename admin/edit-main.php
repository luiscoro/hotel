...
?>
    ...
    <head>
        ...
        <title>Rio Hotel | Portadas</title>
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $row) {               ?>
                                                            <div class="form-group"> <label for="exampleInputEmail1">Título:</label> <input type="text" class="form-control" name="roomname" value="<?php echo $row->Title; ?>" required='true'> </div>
                                                            <div class="form-group"> <label for="exampleInputEmail1">Imagen:</label> &nbsp;&nbsp;
                                                                ...
                                                                <a href="changeimagem.php?editid=<?php echo $row->ID; ?>"> &nbsp; Editar imagen</a>
                                                            </div>
                                                    <?php $cnt = $cnt + 1;
                                                        }
                                                    } ?>
