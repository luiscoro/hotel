...
if (strlen($_SESSION['hbmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $sql = "insert into tblgalleryh(Image)values(:img)";
            ...
            if ($LastInsertId > 0) {
                echo '<script>alert("La imagen ha sido agregada.")</script>';
                echo "<script>window.location.href ='add-galleryh.php'</script>";
            } else {
...
?>
    ...
    <head>
        ...
        <title>Rio Hotel | Agregar imagen</title>
        <!-- Favicon -->
                                    ...
                                    <div class="forms">
                                        <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                            <div class="form-title">
                                                <h4>Agregar imagen a galería de hotel</h4>
                                            </div>
                                            <div class="form-body">
