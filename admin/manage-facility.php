														...
														if ($query->rowCount() > 0) {
															foreach ($results as $row) {               ?>
																<tr>
																	...
																	<td class="d-none d-sm-table-cell"><a href="manage-facility.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');">Eliminar</a></td>
																</tr>
														<?php $cnt = $cnt + 1;
															}
														} ?>
