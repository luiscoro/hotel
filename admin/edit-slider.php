												...
												<form method="post" enctype="multipart/form-data">
													...
													if ($query->rowCount() > 0) {
														foreach ($results as $row) {               ?>
															<div class="form-group"> <label for="exampleInputEmail1">Texto a mostrar:</label> <input type="text" class="form-control" name="roomname" value="<?php echo $row->title; ?>" required='true'> </div>
															<div class="form-group"> <label for="exampleInputEmail1">Imagen:</label> &nbsp;&nbsp;
																...
																<a href="changeimagesl.php?editid=<?php echo $row->id; ?>"> &nbsp; Editar imagen</a>
															</div>
													<?php $cnt = $cnt + 1;
														}
													} ?>
