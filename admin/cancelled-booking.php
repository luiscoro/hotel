											...
											<div class="form-body">
												...
												<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
													...
													<tbody>
														...
														$sql = "SELECT tbluser.*,tblbooking.BookingNumber,tblbooking.Status,tblbooking.BookingDate from tblbooking join tbluser on tblbooking.UserID=tbluser.ID where tblbooking.Status='Cancelada' LIMIT $offset, $no_of_records_per_page";
														...
														if ($query->rowCount() > 0) {
															...
															<tr>
																<td colspan="8" style="color:red; font-size:22px; text-align:center">No se encontraron resultados</td>
															</tr>
														<?php } ?>
													</tbody>
												</table>
