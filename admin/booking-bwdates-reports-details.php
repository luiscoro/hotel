											...
											<div class="form-body">
												...
												<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
													...
													<tbody>
														...
														$sql = "SELECT * from tblbooking where date(BookingDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
															...
															foreach ($results as $row) {               ?>
																<tr>
																	...
																	<?php if ($row->Status == "") { ?>
																		...
																		<td class="font-w600"><?php echo "No aprobada aún"; ?></td>
																	<?php } else { ?>
																		<td class="d-none d-sm-table-cell">
