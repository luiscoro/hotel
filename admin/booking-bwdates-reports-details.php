									...
									<div class="forms">
										<div class="form-grids widget-shadow" data-example-id="basic-forms">
											<div class="form-title">
												<h4>Reporte de reservas entre fechas</h4>
											</div>
											...
											<div class="form-body">
												...
												?>
												<h4 align="center" style="color:#180a01">Reporte desde <?php echo $fdate ?> hasta <?php echo $tdate ?></h4>
												<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
													...
													<tbody>
														...
														$sql = "SELECT tbluser.*,tblbooking.ID,tblbooking.Status,tblbooking.BookingDate from tblbooking join tbluser on tblbooking.UserID=tbluser.ID where date(BookingDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
