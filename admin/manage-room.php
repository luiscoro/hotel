...
?>
	...
	<head>
		...
		<title>Rio Hotel | Gestionar Habitación</title>
															...
															foreach ($results as $row) {               ?>
																<tr>
																	...
																	<td class="d-none d-sm-table-cell">
																		<span class="badge badge-primary">$<?php echo htmlentities($row->Price); ?></span>
																	</td>
																	<td class="d-none d-sm-table-cell"><a href="edit-room.php?editid=<?php echo ($row->ID); ?>">Editar</a></td>
