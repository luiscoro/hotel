...
?>
	...
	<head>
		...
		<!-- Title -->
		<title>Rio Hotel | Dashboard</title>
					...
					<div class="content">
							...
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="content-top-1">
										<h4 class="text-left text-uppercase" style="color: orange"><a href="new-booking.php"><b>Reservas pendientes</b></a></h4>
						...
						<div class="col-md-12" style="padding-top: 20px">
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
									<div class="content-top-1">
										<h4 class="text-left text-uppercase" style="color: red"><a href="read-enquiry.php"><b>Consultas leídas</b></a></h4>
										<div class="row vertical-center-box vertical-center-box-tablet">
											<?php
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="content-top-1">
										<h4 class="text-left text-uppercase" style="color: magenta"><a href="unread-enquiry.php"><b>Consultas no leídas</b></a></h4>
										<div class="row vertical-center-box vertical-center-box-tablet">
											<?php
