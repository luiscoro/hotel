...
if (strlen($_SESSION['hbmsaid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		echo '<script>alert("La habitación ha sido actualizada")</script>';
												...
												<form method="post" enctype="multipart/form-data">
													...
													if ($query->rowCount() > 0) {
														foreach ($results as $row) {               ?>
															...
															<div class="form-group"> <label for="exampleInputEmail1">Imagen:</label> &nbsp;&nbsp;
															...
															<div class="form-group"> <label for="exampleInputEmail1">Imagen 1:</label> &nbsp;&nbsp;
																...
																<a href="changeimage1.php?editid=<?php echo $row->ID; ?>"> &nbsp; Editar imagen</a>
															</div>
															<div class="form-group"> <label for="exampleInputEmail1">Imagen 2:</label> &nbsp;&nbsp;
																...
																<a href="changeimage2.php?editid=<?php echo $row->ID; ?>"> &nbsp; Editar imagen</a>
															</div>
															<div class="form-group"> <label for="exampleInputEmail1">Imagen 3:</label> &nbsp;&nbsp;
																...
																<a href="changeimage3.php?editid=<?php echo $row->ID; ?>"> &nbsp; Editar imagen</a>
															</div>
															<div class="form-group"> <label for="exampleInputEmail1">Servicios:</label> <select type="text" name="roomfac[]" id="roomfac" value="" class="form-control" multiple="multiple">
