                                    ...
                                    <div class="forms">
                                        <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                            <div class="form-title">
                                                <h4>Gestionar portadas de páginas</h4>
                                            </div>
                                            <div class="form-body">
                                                ...
                                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $ret = "SELECT ID FROM tblmain";
                                                        $query1 = $dbh->prepare($ret);
                                                        $query1->execute();
                                                        $results1 = $query1->fetchAll(PDO::FETCH_OBJ);
                                                        $total_rows = $query1->rowCount();
                                                        $total_pages = ceil($total_rows / $no_of_records_per_page);
                                                        $sql = "SELECT * from tblmain LIMIT $offset, $no_of_records_per_page";
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $row) {               ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="d-none d-sm-table-cell"><a href="edit-main.php?editid=<?php echo ($row->ID); ?>">Editar</a></td>
